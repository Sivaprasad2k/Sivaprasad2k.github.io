...
export const RoomDesk: React.FC<RoomDeskProps> = ({ parallaxX, parallaxY }) => {
  return (
    ...
    >
      ...
      {/* Rear Wooden Riser Shelf (#221610 Dark Walnut Riser) */}
      <div className="absolute top-[32%] left-[6%] right-[18%] h-[14%] bg-[#221610] rounded-t-md border-t-2 border-[#3F2B1F] shadow-2xl flex items-center justify-between px-6">
      ...
      {/* Main Desktop Surface Platform (#2B1E17 Rich Dark Walnut Furniture) */}
      <div className="absolute top-[44%] left-0 right-0 h-[14%] bg-[#2B1E17] border-t-2 border-[#503628] shadow-2xl overflow-hidden flex items-center justify-between px-8">
      ...
      <div className="absolute top-[58%] left-[2%] right-[2%] bottom-0 flex justify-between px-6 opacity-95">
        ...
        <div className="w-10 h-full bg-[#1B120D] border-r-2 border-[#2B1E17] shadow-2xl flex flex-col justify-between">
          <div className="w-full h-3 bg-[#2B1E17]" />
        </div>

        {/* Right Solid Leg Column */}
        <div className="w-10 h-full bg-[#1B120D] border-l-2 border-[#2B1E17] shadow-2xl flex flex-col justify-between">
          <div className="w-full h-3 bg-[#2B1E17]" />
        </div>
      </div>
