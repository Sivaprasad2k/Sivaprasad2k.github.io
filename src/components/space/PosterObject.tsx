...
export const PosterObject: React.FC<PosterObjectProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute ${isLinkedin ? 'left-[74%] top-[10%]' : 'left-[74%] top-[32%]'} w-40 h-36 bg-[#121315] border-2 rounded-lg p-2.5 flex flex-col justify-between transition-all duration-300 cursor-pointer z-20 group shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#65B8FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0D10] ${
        isFocused
    ...
    >
      ...
      {/* Icon Graphic Center */}
      <div className={`p-2.5 rounded-lg bg-[#08090B] border border-[#1E2126] flex flex-col items-center justify-center space-y-1 my-auto text-center shadow-inner ${
