...
export const RoomServerRack: React.FC<RoomServerRackProps> = ({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="button"
      aria-label="Server Rack - Systems & Stack"
      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onClick(); } }}
      className={`absolute right-[5%] bottom-[12%] w-32 h-56 bg-[#17191D] border-2 rounded-lg p-3 flex flex-col justify-between transition-all duration-300 cursor-pointer z-30 group shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#65B8FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0D10] ${
        isFocused
    ...
    >
      ...
      <div className="space-y-2 py-1 font-mono text-[9px]">
        {/* Blade 1: API */}
        <div className="bg-[#0B0D10] p-1.5 rounded border border-[#25282D] flex items-center justify-between group-hover:border-[#65B8FF]/40 transition-colors">
      ...
      <div className="h-4 bg-[#0B0D10] rounded border border-[#25282D] flex items-center justify-center font-mono text-[8px] text-[#64748b]">
