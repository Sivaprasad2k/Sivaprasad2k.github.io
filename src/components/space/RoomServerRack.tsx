...
export const RoomServerRack: React.FC<RoomServerRackProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute left-[15%] bottom-[8%] w-36 h-56 bg-[#111316] border-2 rounded-lg p-3 flex flex-col justify-between transition-all duration-300 cursor-pointer z-30 group shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#65B8FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0D10] ${
        isFocused
