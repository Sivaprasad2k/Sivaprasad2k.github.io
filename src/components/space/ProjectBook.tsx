...
export const ProjectBook: React.FC<ProjectBookProps> = ({
  ...
  return (
    ...
    >
      {/* Book Cover Container (#181A1D Dark Matte Graphite Cover with Gold Spine) */}
      <div className={`w-full h-full bg-[#181A1D] border-2 rounded-r-md p-2 flex flex-col justify-between relative overflow-hidden transition-all duration-300 shadow-2xl ${
        isFocused
          ? 'border-[#65B8FF] ring-4 ring-[#65B8FF]/30'
          : 'border-[#2B1D17] group-hover:border-[#65B8FF]/70'
      }`}>
        {/* Book Spine Overlay Line */}
        <div className="absolute left-0 top-0 bottom-0 w-2.5 bg-[#25282D] border-r border-[#33373E]" />
        ...
        {/* Book Icon & Label */}
        <div className="pl-2 flex items-center justify-between border-t border-[#25282D] pt-1 font-mono text-[7.5px] text-[#8494a8]">
