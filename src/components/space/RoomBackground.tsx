  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none [transform-style:preserve-3d]">
      ...
      >
        ...
        <div 
          className="absolute left-[8%] top-[2%] w-[240px] h-[190px] bg-amber-400/20 rounded-full blur-[60px] pointer-events-none"
        />

        {/* Left Warm Desk Lamp Practical Light Cone */}
        <div 
          className="absolute left-[0%] top-[12%] w-[420px] h-[360px] bg-amber-500/15 rounded-full blur-[110px] pointer-events-none"
        />

        {/* Workstation Laptop Soft Cool Screen Glow */}
        <div 
          className="absolute left-[38%] top-[32%] w-[360px] h-[260px] bg-emerald-500/8 rounded-full blur-[95px] pointer-events-none"
        />
      </div>
      ...
      >
        ...
        <div className="absolute right-0 top-0 bottom-0 w-[11%] bg-[#060709] border-l-4 border-[#1A1D22] flex flex-col justify-between p-2">
      ...
      {/* Floor Surface (#0F0E0C Dark Hardwood Floor) */}
      <div 
        className="absolute inset-x-0 bottom-0 h-[32%] bg-[#0F0E0C] transition-transform duration-300 ease-out shadow-2xl"
        style={{
