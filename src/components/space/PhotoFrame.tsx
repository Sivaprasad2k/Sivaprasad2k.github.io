...
export const PhotoFrame: React.FC<PhotoFrameProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute left-[14%] top-[16%] w-44 h-54 bg-[#111316] border-4 rounded-lg p-2.5 flex flex-col justify-between transition-all duration-300 cursor-pointer z-20 group shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#65B8FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0D10] ${
        isFocused
          ? 'border-[#65B8FF] ring-4 ring-[#65B8FF]/30 scale-105'
          : 'border-[#2B1E17] hover:border-[#65B8FF]/70 hover:scale-[1.02]'
      }`}
      style={{
    ...
    >
      ...
      <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 w-24 h-2.5 bg-[#202328] rounded-full border-t border-[#383d44] shadow-lg flex items-center justify-center pointer-events-none">
        <div className="w-16 h-1 bg-amber-400/90 rounded-full blur-[1px]" />
      </div>
